...
final class MessageCatalog
{
    ...
    private const MESSAGES = [
        ...
        'order.countdown.buyer_refund' => 'Target refund date: {date}, if this order is not confirmed before then. Contact support if you need one -- there is no automatic on-chain refund yet.',
        'order.countdown.seller_release' => 'Target release date: {date}, if the buyer does not respond. Contact support if you need this -- there is no automatic on-chain release yet.',
